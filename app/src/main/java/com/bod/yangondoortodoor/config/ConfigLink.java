 ...
 */
 ...
 public class ConfigLink
 {
    ...
    public static String logoutURL = "http://192.168.1.231:8000/api/logout";
    public static String getNewOrderListURL = "http://192.168.1.231:8000/api/getNewOrder";
    public static String requestOrder = "http://192.168.1.231:8000/api/order";
    public static String getOrderDetailURL = "http://192.168.1.231:8000/api/getDetail";
    public static String sendCurrentlatlongURL = "http://192.168.1.231:8000/api/storedispatcherlocation";
    public static String acceptDispatch = "http://192.168.1.231:8000/api/acceptDispatch";
